...
export const ApiRoutes = {
  ...
  COUNT_SHEET: (outlet?: string | null) => (outlet ? `/products/count-sheet?outlet=${outlet}` : '/products/count-sheet'),
  COUNT_APPLY: (outlet?: string | null) => (outlet ? `/products/count-apply?outlet=${outlet}` : '/products/count-apply'),
  COUNT_PRINT: (outlet?: string | null) => (outlet ? `/products/count-print?outlet=${outlet}` : '/products/count-print'),
  ...
  AUDIT_BACKUP_CREATE: '/audit/backup-create',
